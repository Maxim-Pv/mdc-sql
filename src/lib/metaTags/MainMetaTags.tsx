...
const schemaData = {
  ...
  alternateName: [
    'MDCard',
    'Картул читатянулуй молдовенеск',
    'Citizen Card Moldova',
    'Карта гражданина Республики Молдова',
  ],
  description:
    ...
    itemListElement: [
      {
        ...
        description:
          'Круглосуточные консультации врачей на русском и румынском языках с покрытием 98% медицинских вопросов',
        price: '0',
        priceCurrency: 'RUB',
  ...
  return (
    <>
      <>
        ...
        <meta
          name="description"
          content="Карта гражданина Молдовы: скидки в молдавские рестораны (33,100 поисков), социальные пособия в Молдове, телемедицина 24/7, юрпомощь"
        />

        <meta
          name="keywords"
          content="карта гражданина молдовы, скидки в молдавские рестораны, социальные пособия в молдове, сбербанк тирасполь, льготы молдаванам в россии, телемедицина молдова, социальная поддержка граждан молдовы, юридическая консультация кишинев, 900 лей пенсионерам в молдове, оформление пенсий рф, бесплатная юридическая помощь, телемедицинские услуги, юридическая консультация тирасполь, сбербанк онлайн пмр, банковские услуги пмр, льготный курс валют, приоритетное обслуживание, консультации врачей, медицинская поддержка, правовая помощь, миграционное право, сбербанк бендеры, сбербанк рыбница, сбербанк дубоссары, социальные программы молдаван, материальная помощь, государственная поддержка, диаспора молдовы, граждане молдовы в россии, пенсионеры молдовы, держатели карт, министерство диаспоры молдова, кому положена социальная помощь в молдове, социальная помощь пенсионерам в молдове, социальные выплаты в молдове, пенсия россии в пмр"
        />

        {/* РАСШИРЕННАЯ АВТОРСКАЯ ИНФОРМАЦИЯ */}
        <meta
          name="author"
          content="Карта гражданина Молдовы | Официальный портал Республики Молдова | Министерство диаспоры Республики Молдова"
        />
        <meta
          name="publisher"
        ...
        <meta
          name="copyright"
          content="© 2024-2025 Республика Молдова. Все права защищены. Официальный портал карты гражданина Молдовы"
        />
        ...
        <meta
          name="subject"
          content="Карта гражданина Молдовы: льготы, социальная поддержка, банковские услуги, телемедицина, юридическая помощь"
        />
        <meta
          name="abstract"
          content="Официальная карта гражданина Молдовы предоставляет скидки в молдавские рестораны, пенсионную поддержку, телемедицину и юридические консультации"
        />
        <meta
          name="topic"
        ...
        <meta
          property="og:title"
          content="Карта гражданина Молдовы: скидки в молдавские рестораны, телемедицина 24/7, юридическая помощь"
        />
        <meta
          property="og:description"
          content="🇲🇩 Оформляйте карту гражданина Молдовы и получайте безлимитную связь от СберМобайла, юридическую поддержку, бесплатную телемедицину и скидки в молдавские рестораны"
        />
        ...
        <meta
          ...
          content="Карта гражданина Молдовы - скидки в молдавские рестораны, телемедицина, юридическая помощь"
        />
        ...
        <meta
          ...
          content="name=Пенсионная помощь;action-uri=/pension-support;icon-uri=/favicon.ico"
        />
        ...
        <link
          ...
          title="Обновления карты гражданина Молдовы"
          href="/atom.xml"
        />
        ...
        <meta
          name="news_keywords"
          content="карта гражданина молдовы, скидки в молдавские рестораны, социальные пособия молдова, телемедицина, юридическая помощь, льготы молдаванам"
        />
