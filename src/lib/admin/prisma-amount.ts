  ...
  result: {
    order: {
      amount: {
        ...
        compute(o) { return Number((o.amountCents / 100).toFixed(2)); }, // 2900.00
      },
    },
    orderItem: {
      unitPrice: {
        needs: { unitPriceCents: true },
        compute(o) { return Number((o.unitPriceCents / 100).toFixed(2)); },
      },
      total: {
        needs: { totalCents: true },
        compute(o) { return Number((o.totalCents / 100).toFixed(2)); },
      },
    },
  },
});
